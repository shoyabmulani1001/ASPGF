            ...
            <div className="p-6 md:p-12 h-full flex flex-col">
              <div className="flex-grow flex flex-col justify-center">
                <div className="flex items-center gap-4 mb-4">
                  <span
                    className={`${cabin.className} flex items-center gap-2 text-[#00715D] text-[10px] md:text-xs font-bold uppercase tracking-widest bg-[#3ed0a6]/10 px-3 py-1 rounded-full`}
                  >
                    <FiCalendar size={14} /> {selectedNews.date}
                  </span>
                  <span
                    className={`${cabin.className} flex items-center gap-2 text-white/50 text-[10px] md:text-xs font-bold uppercase tracking-widest`}
                  >
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                  <h3
                    className={`${cabin.className} text-white/40 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]`}
                  >
                    Next News & Events
                  </h3>
