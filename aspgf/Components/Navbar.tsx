  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex w-full items-stretch">
        ...
        <Link
          href="/contactUs"
          className="h-16 px-10 bg-[#A828C6] hover:bg-purple-500 transition-all flex items-center gap-2 text-white font-black text-sm uppercase tracking-widest cursor-pointer whitespace-nowrap"
        >
        ...
        <div className="p-8 pt-24 flex flex-col h-full">
          ...
          <div className="mt-auto space-y-6">
            ...
            <Link
              href="/contactUs"
              onClick={() => setIsMenuOpen(false)}
              className="w-full py-4 bg-[#8b13a5] text-white rounded-2xl flex items-center justify-center gap-2 font-black uppercase tracking-[0.1em] shadow-lg shadow-purple-200"
            >
              <Phone size={18} fill="white" />
